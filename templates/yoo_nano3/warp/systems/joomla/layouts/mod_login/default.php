...
<?php if ($type == 'logout') : ?>
	...
	<form class="uk-form" action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post">
		...
		<div class="uk-form-row"><button class="uk-button uk-button-primary" value="<?php echo JText::_('JLOGOUT'); ?>" name="Submit" type="submit"><?php echo JText::_('JLOGOUT'); ?></button></div>
...
<?php else : ?>
	...
	<form class="uk-form" action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post">
		...
		<div class="uk-form-row"><button class="uk-button uk-button-primary" value="<?php echo JText::_('JLOGIN') ?>" name="Submit" type="submit"><?php echo JText::_('JLOGIN') ?></button></div>
