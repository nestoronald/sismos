...
<form class="uk-form" action="<?php echo JRoute::_('index.php?option=com_users&task=profile.save'); ?>" method="post" enctype="multipart/form-data">
		...
		<?php if (count($fields)): ?>
			<fieldset>
				...
				<?php foreach ($fields as $field): ?>
					...
					<?php else: ?>
						<div class="uk-form-row"><?php echo $field->label.' '.$field->input; ?>
