...
<form class="uk-form uk-panel uk-panel-box" id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post" name="searchForm">
	...
	<fieldset>
		...
		<div class="uk-form-row">
			...
			<button class="uk-button uk-button-primary" name="Search" onclick="this.form.submit()" class="button"><?php echo JText::_('COM_SEARCH_SEARCH'); ?></button>
		</div>
