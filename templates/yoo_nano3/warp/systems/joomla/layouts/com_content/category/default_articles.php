...
<form class="uk-form" action="<?php echo htmlspecialchars(JFactory::getURI()->toString()); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="uk-table uk-table-hover uk-table-striped" border="0" cellspacing="0" cellpadding="0">
		...
		<thead>
			<tr>
				...
				<th class="uk-width-2-10"><?php echo JHtml::_('grid.sort', 'JAUTHOR', 'author', $listDirn, $listOrder); ?></th>
				<?php endif; ?>
				
				<?php if ($this->params->get('list_show_hits', 1)) : ?>
				<th class="uk-text-center uk-width-1-10"><?php echo JHtml::_('grid.sort', 'JGLOBAL_HITS', 'a.hits', $listDirn, $listOrder); ?></th>
				<?php endif; ?>
		...
		<tbody>
			...
			<tr>
				...
				<?php if (in_array($article->access, $this->user->getAuthorisedViewLevels())) : ?>
					...
					<?php if ($this->params->get('list_show_hits', 1)) : ?>
					<td class="uk-text-center"><?php echo $article->hits; ?></td>
					<?php endif; ?>
	...
	<p><?php echo JHtml::_('icon.create', $this->category, $this->category->params); ?> <?php echo JText::_('TPL_WARP_CREATE_ARTICLE'); ?></p>
	<?php  endif; ?>
